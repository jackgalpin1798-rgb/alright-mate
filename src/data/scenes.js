...
export const SCENES = {
  heathrow_arrivals: {
    ...
    bgPhoto: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1400&q=80',
    accentColor: '#3B6FD8',
    ...
    character: {
      ...
      description: 'Leather jacket, dark hair, stubble. Holding a misspelled sign.',
      skin: '#c0785a',
      hair: '#1a0a02',
      eye: '#2a1200',
      hasStubble: true,
      hasLeatherJacket: true,
    },
  ...
  caff_morning: {
    ...
    bgPhoto: 'https://images.unsplash.com/photo-1567521464027-f127ff144326?w=1400&q=80',
    accentColor: '#F5A623',
    ...
    character: {
      ...
      description: 'Grey hair, apron, glasses on head. A little suspicious at first.',
      skin: '#d4906a',
      hair: '#888888',
      eye: '#2e1a00',
      hasApron: true,
  ...
  crown_pub: {
    ...
    bgPhoto: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=1400&q=80',
    accentColor: '#C8A45A',
    ...
    character: {
      ...
      description: 'Deadpan. Seen everything. Still here.',
      skin: '#b5785a',
      hair: '#3a3028',
      eye: '#241800',
      hasPubApron: true,
